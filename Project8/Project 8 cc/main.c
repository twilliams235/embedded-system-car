...
extern volatile char USB_Process_Rx[SMALL_RING_SIZE];
...
//          i = 0;
//          for (i = 0; i < 10; i++) {
//              if(USB_Process_Rx[i] == '\r') {
//                  //i = 0;
//                  break;
//              }
//              else {
//                  display_line[1][i] = USB_Process_Rx[i];
//              }
//          }
//          display_changed = TRUE;
//          update_display = TRUE;
      ...
      if(displayflag == HIGH) {
          ...
          for (i = 0; i < 10; i++) {
              if(USB_Ring_Rx[i] == '\r') {
                ...
                display_line[3][i] = USB_Ring_Rx[i];
                display_changed = TRUE;
                update_display = TRUE;
              }
          }
...
//      if(displayflag == HIGH) {
//          displayflag = LOW;
//          while(usb_rx_wr != usb_rx_rd) {
//              USB_Process_Rx[process_index] = USB_Ring_Rx[usb_rx_rd];
//              if(USB_Process_Rx[process_index]== '\n') {
...
//                      if(USB_Process_Rx[i] == '\r') {
//                          usb_rx_rd++;
//                          if(usb_rx_rd >= sizeof(USB_Process_Rx)) {
//                              usb_rx_rd = 0;
//                          }
//                          break;
//                      }
//                      else {
//                          display_line[3][i] = USB_Process_Rx[i];
//                          display_changed = TRUE;
//                          update_display = TRUE;
//                      }
//                  }
